<%@ page import="com.kcosic.jwp.shared.enums.ParameterEnum" %><%--
...
<head>
    ...
    <script type="text/javascript" src="${contextPath}/assets/scripts/custom/login.js"></script>
</head>
<body>
<div class="container h-100 d-flex justify-content-center align-items-center">
    <form action="login" method="post" class="needs-validation" novalidate>
        <% if ((boolean) request.getAttribute(ParameterEnum.HAS_ERROR.toString())) { %>
        <div class="row mb-4">
                    ...
                    <div class="col ">
                        <div class="input-group has-validation mb-3">
                            ...
                            <div class="form-floating ">
                                <input name="login" type="text" class="form-control" aria-describedby="inputGroupPrepend" id="login" required>
